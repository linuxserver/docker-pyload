...
<!-- Please read the https://github.com/linuxserver/docker-pyload/blob/ng/.github/CONTRIBUTING.md -->
...
* Update the image: `docker pull ghcr.io/linuxserver/pyload`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/pyload:latest .
```
